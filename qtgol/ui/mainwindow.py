...
# Form implementation generated from reading ui file 'qtgol/ui/qtGol.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionstart_pause.setCheckable(True)
        self.actionstart_pause.setChecked(False)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("asset/start.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("asset/speed.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSpeed.setIcon(icon1)
        self.actionSpeed.setObjectName("actionSpeed")
        self.actionQuit = QtWidgets.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("asset/exit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionQuit.setIcon(icon2)
        self.actionQuit.setMenuRole(QtWidgets.QAction.QuitRole)
        self.actionQuit.setObjectName("actionQuit")
        self.actionConfig = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("asset/config.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
